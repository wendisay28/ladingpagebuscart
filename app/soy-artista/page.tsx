...
import { ArrowRight, CheckCircle, Music, Calendar, DollarSign, MapPin, Users, Mail as MailIcon, Instagram, Youtube, Facebook, User, Loader2, XCircle } from 'lucide-react';
...
export default function SoyArtistaPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden font-sans">
      <Navigation activeSection="soy-artista" />
      <div className="pt-16">
        {/* Animated Background */}
            ...
            <div className="max-w-4xl mx-auto">
              <div className="relative">
                ...
                {[
                  ...
                  { step: 3, title: "Recibe Ofertas", description: "Los organizadores te contactarán para tus servicios.", icon: <MailIcon className="w-6 h-6" /> },
              ...
              <div className="md:flex">
                <div className="md:w-1/2 bg-gradient-to-br from-purple-900/20 to-pink-900/20 p-8 md:p-12 flex flex-col justify-between">
                  ...
                  <div className="mt-8">
                    ...
                    <a href="mailto:artistas@buscart.co" className="flex items-center text-purple-400 hover:text-purple-300"><MailIcon className="w-5 h-5 mr-2" /> artistas@buscart.co</a>
                  </div>
                </div>
